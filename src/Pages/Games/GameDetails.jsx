    ...
    <div>
      ...
      <div className='flex items-center justify-center gap-15 mb-5'>
        ...
        <div className='flex flex-col items-center gap-2'>
            ...
            <p className='flex items-center gap-2'><img className='w-7' src="https://img.icons8.com/?size=100&id=13662&format=png&color=000000" alt="" /><span>{game.developer}</span></p>
        </div>
      </div>
        <a href={game.downloadLink} className="btn bg-[#7eb0b5] text-white mb-4">
        Download Game</a>
    </div>
  </div>
</div>
